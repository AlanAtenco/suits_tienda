...
<div class="container mt-5">
    <div class="row justify-content-center bg-card">
        ...
        <div class="col-10 text-end mt-3">
            <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#agregarModal">Añadir
                producto
            </button>
...
<div class="modal fade text-dark" id="editar-usuario" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
